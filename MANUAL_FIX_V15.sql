-- ===============================================================
-- MANUAL FIX V15: CRITICAL RPCs
-- Executar este script no Supabase SQL Editor para corrigir
-- o erro de registo e permitir automação futura.
-- ===============================================================

-- 1. Helper para Execução de SQL (Permite correções automáticas futuras)
...
-- 2. RPC de Registo V9 (Otimizado e Atómico)
...
-- 3. Cleanup Zombie Tournaments (Prevent 'Running' with 0 players)
