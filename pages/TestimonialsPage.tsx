...
const generateTestimonials = (count: number) => {
    ...
    const testimonialTexts = [
        ...
        'The ranking system is super competitive. grinding for Diamond rank is a blast!',
        'Very beginner friendly. The academia section helped me understand the basics quickly.',
        'The anti-cheat system is top notch. I feel safe playing on this platform.',
        'Great daily rewards and excellent customer support. Highly recommended!',
        ...
        'Love the rewards program. I\'ve earned so many chips!',
        'The anti-cheat system gives me confidence that every game is fair.',
        'Top-up is instant and easy. No hassle at all.',
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-lg max-w-2xl mx-auto mb-2">
                            Join thousands of satisfied players who trust BestPoker.Cards.
                        </p>
