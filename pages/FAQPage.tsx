...
const ALL_FAQS = [
    ...
    { category: "Getting Started", q: "Can I play on mobile?", a: "Yes, BestPoker.Cards is fully responsive and works directly in your mobile browser. Native apps coming soon." },
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-lg max-w-2xl mx-auto">
                            Find answers to common questions about BestPoker.Cards. Can't find what you're looking for? Contact our support team.
                        </p>
                    </motion.div>
                </div>
